...
class AutoGen():
    def __init__(self, mj_model: mujoco.MjModel):
        ...
        r = Runfiles.Create()
        with open(r.Rlocation("walter-v4-floortest-z-control/config/walter_sr_v4/walter_sr_config.yaml"), "r") as file:
...
def main(argv):
    ...
    mj_model = mujoco.MjModel.from_xml_path(
        r.Rlocation(
            path="mujoco-models/models/walter_sr/WaLTER_Senior_v4.xml",
        )
    )
